...
<body>
    <div class="wrap">
        ...
        <div class="sub_menu">
            <h3>타이어</h3>
            <ul>
                <li><a href="../concert/list.php">승용차별타이어</a></li>
                <li class="current"><a href="/list.php">특수타이어</a></li>
            </ul>
        </div>
        <article id="content">
            <div class="title_area">
                <div class="line_map">
                    <span class="hidden">HOME</span><i class="fas fa-home"></i> &gt; 타이어 &gt; <strong>특수타이어</strong>
                </div>
                <h2>특수타이어</h2>
            </div>
            <div class="content_area">
                <p>한국타이어의 <span class="point">모든 트럭/버스용 타이어</span>는 까다로운 온/오프라인 주행 여건에 최적화되어 있습니다.<br>다양한 주행 환경에 맞는 최고 성능의 타이어를 만나보세요.</p>
